...
const GAS_API_URL = "　https://script.google.com/macros/s/AKfycbzMm9fGZBcEAdyBq1Zm0YzlhY0pSkVcpxL9F5SOLNapMq3Zn8XzSsraES9OXlrcIDJ-Bg/exec";//読み込むスプレットシートを選択するコード
