...
const GAS_API_URL = "https://script.google.com/macros/s/AKfycbzqfAKPAwfuWmbvLVuuiPELleFO5r6jnCK9rLsHcMoempXfQ4KPMZxBbujEzEu7tbXaiQ/exec";//読み込むスプレットシートを選択するコード
