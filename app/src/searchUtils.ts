export const normalizeCategoryValue = (value: string | null | undefined): string => {
...
export const tokenizeSearchQuery = (value: string | null | undefined): string[] => {
  return normalizeSearchText(value)
    .split(/\s+/)
    .filter(Boolean);
};

export const getUnifiedLocationGroup = (rawLocation: string | null | undefined): string => {
...
export const matchesSearchQuery = (group: Record<string, any>, searchTerm: string): boolean => {
